(function(){
    ...
    function DataServiceFn($http,$q){
        ...
        self.getAllVehicles = function (){
            ...
            $http({
                method:'GET',
                url:'http://localhost:8085/api/api/vehicles/getAll'
            })
        ...
        self.getAllAlerts = function (){
            ...
            $http({
                method:'GET',
                url:'http://localhost:8085/api/api/alerts/getAll'
            })
                .success(function(data){
                    defer.resolve(data);
                })
        ...
        self.getAllReadings = function (vin){
            ...
            $http({
                method:'GET',
                url:'http://localhost:8085/api/api/readings/'+ vin
            })
                .success(function(data){
                    defer.resolve(data);
                })
...
console.log("vin", vin);
            $http({
                method:'GET',
                url:'http://localhost:8085/api/api/alerts/' + vin
            })
                .success(function(data){
                    defer.resolve(data);
                })
